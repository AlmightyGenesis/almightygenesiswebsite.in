...
function openPage (type) {
   ...
   case "training":
    ...
    const introBox = document.getElementById("pageIntro");

    if(type === "overview"){
    introBox.style.borderLeftColor = "#00d4ff";
    }
    else if(type === "mission"){
    introBox.style.borderLeftColor = "#2E4F3E";
    }
    else if(type === "vision"){
    introBox.style.borderLeftColor = "#ffcc00";
    }
    else if(type === "why"){
    introBox.style.borderLeftColor = "#045075";
    }
    else if(type === "industry"){
    introBox.style.borderLeftColor = "#0f80d6";
    }
    else if(type === "lead"){
    introBox.style.borderLeftColor = "#ffffff";
    } 
    else if(type === "customer"){
    introBox.style.borderLeftColor = "#111111";
    }
    else if(type === "training"){
    introBox.style.borderLeftColor = "#6fb1d4";
    }
    else if(type === "call"){
    introBox.style.borderLeftColor = "#ffffff";
    }
    else if(type === "business"){
    introBox.style.borderLeftColor = "#79b9e6";
    }
    else if(type === "work"){
    introBox.style.borderLeftColor = "#382d09";
    }
    else if(type === "intern"){
    introBox.style.borderLeftColor = "#0e0e0f";
    }
